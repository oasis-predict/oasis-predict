...
TEST_TRADES = [
    {"ticker": "DD-1", "action": "BUY_YES", "confidence": "HIGH", "yes_price": 40, "outcome": "NO"},
    {"ticker": "DD-2", "action": "BUY_NO", "confidence": "HIGH", "yes_price": 30, "outcome": "YES"},
    {"ticker": "DD-3", "action": "BUY_YES_STRONG", "confidence": "HIGH", "yes_price": 50, "outcome": "NO"},
    {"ticker": "DD-4", "action": "BUY_YES", "confidence": "HIGH", "yes_price": 20, "outcome": "YES"},
    {"ticker": "DD-5", "action": "BUY_NO_STRONG", "confidence": "HIGH", "yes_price": 35, "outcome": "YES"},
    {"ticker": "DD-6", "action": "BUY_NO", "confidence": "HIGH", "yes_price": 25, "outcome": "YES"},
    {"ticker": "DD-7", "action": "BUY_YES_STRONG", "confidence": "HIGH", "yes_price": 60, "outcome": "NO"},
    {"ticker": "DD-8", "action": "BUY_NO", "confidence": "HIGH", "yes_price": 20, "outcome": "YES"},
]
...
def main():
    ...
    for trade in TEST_TRADES:
        ...
        print("Drawdown %         :", round(drawdown_pct, 2))
        print("Warning active     :", drawdown_pct >= DRAWDOWN_WARNING_PERCENT)
        print("Stop zone active   :", drawdown_pct >= DRAWDOWN_STOP_PERCENT)
        print("Consecutive losses :", consecutive_losses)

    print("=" * 80)
    print("FINAL DRAWDOWN TEST SUMMARY")
    print("=" * 80)
